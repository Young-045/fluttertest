...
class DataTableFastRoute extends StatefulWidget {
  const DataTableFastRoute({super.key});

  @override
  State<DataTableFastRoute> createState() => _DataTableFastRouteState();
}

class _DataTableFastRouteState extends State<DataTableFastRoute> {
  ...
  DataTable _dataTable() {
    return DataTable(
      ...
      showCheckboxColumn:
          true, // 是否展示左侧 checkbox，默认为 true，设置为 false，最左侧不展示 checkbox
